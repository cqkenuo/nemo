...
class Domain(daobase.DAOBase):
    ...
    def __fill_org_domain_ip_where(self, org_id, domain, ip):
    ...
    def count_by_org_domain_ip(self, org_id=None, domain=None, ip=None):
        ...
        # 查询条件
        where_sql, where_param = self.__fill_org_domain_ip_where(
            org_id, domain, ip)
    ...
    def gets_by_org_domain_ip(self, org_id=None, domain=None, ip=None, fields=None, page=1, rows_per_page=None, order_by=None):
